...
Hello, my name is Suthep Chantawee, also known as Banana. I graduated with a degree in Electronic Engineering from Suranaree University of Technology. I have experience in software development and coding in various areas, including Front-End, Back-End, and API Development. 

### My skills and experience are as follows:

- **Front-End Development**: 
  I write code using **React** and **Next.js** based on design mockups to create responsive and user-friendly interfaces.

- **Mobile Development**: 
  I develop mobile applications using **Flutter**, including implementing processes like pin login for app access and managing the navigation between different pages.

- **API Development**: 
  I build APIs for sending data using **JavaScript**, **PostgreSQL**, and **Express**, as well as retrieving data from web sources and databases like **Kibana**.

- **Data Flow Design**: 
  I design efficient data extraction and processing flows using **draw.io** to create well-structured data architectures.

- **Automation**: 
  I develop and manage automation processes using **Jenkins** to run commands for data extraction, utilizing **Jenkins** and **Docker** for automated workflows.

- **Python Development**: 
  I write **Python** scripts for logic implementation, such as calculating the **Moving Average (MA)** as per the defined algorithm.

- **Web Development & Bug Fixing**: 
  I troubleshoot and fix bugs on web applications using **React**, **Next.js**, **JavaScript**, and **TypeScript**, ensuring improved UI and functionality.

- **Mobile-to-Web Conversion**: 
  I adapt **Flutter** mobile code to work on the web using **Next.js** and **TypeScript**, ensuring cross-platform compatibility.

- **Testing & Clean Code**: 
  I write **Unit Tests** and perform **API Testing** using **Jest** to ensure high-quality, clean code.
...
### Languages:
<a href="https://nodejs.org/en"><img src="https://user-images.githubusercontent.com/70640558/206164106-0f214e1f-00c1-4f4f-9915-0eb815905e64.png" alt="Node.js" width="70" height="70"></a>
<a href="https://www.typescriptlang.org"><img src="https://user-images.githubusercontent.com/70640558/206169912-ef69cf57-528d-4261-b490-b0ccaf278c51.png" alt="TypeScript" width="70" height="70"></a>
<a href="https://www.sql.com"><img src="https://user-images.githubusercontent.com/70640558/206169350-a5dcba3d-ee70-4e03-879e-02264765698e.png" alt="SQL" width="70" height="70"></a>
<a href="https://dart.dev"><img src="https://user-images.githubusercontent.com/70640558/205966841-fe9532ac-b1db-4170-851a-7c726526c848.svg" alt="Dart" width="70" height="70"></a>
